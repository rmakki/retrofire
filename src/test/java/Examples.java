    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (firebaseResponse.isSuccess()) {
                Gson gson = new Gson();
                firebaseUID = gson.fromJson(firebaseResponse.getBody(), FirebaseUID.class);
            ...
            model.UserDetails userDetails = fbSvc.getUserDetails("userDetails/uid11/");
            if (!(userDetails == null)) {
                // Found the info
                System.out.print("Retrieving uid1 Bio directly : " + userDetails.getBio());
            }
            else {
                // Did not find info(we pass a non existing path), firebase returned null
